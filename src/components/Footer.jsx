    ...
    <footer className='bg-gray-800 text-white py-8 px-4 md:px-16 lg:px-24'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
        <div>
          ...
          <p className='mt-4'>
            All your needs are available here. All shopping is under your fingers 
          </p>
        </div>
        ...
        <div>
          ...
          <a href="https://github.com/KrishnaVarmaVuyyuri" className='hover:text-gray-400'><FaGithub/></a>
          <a href="http://www.linkedin.com/in/varma-vuyyuri-68860023b" className='hover:text-gray-400'><FaLinkedin/></a>
          </div>
