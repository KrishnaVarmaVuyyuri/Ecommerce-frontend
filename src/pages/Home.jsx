        ...
        <div className='bg-white mt-2 px-4 md:px-16 lg:px-24'>
            <div className='container mx-auto py-4 flex flex-col md:flex-row'>
                ...
                <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'>
                    <img src={HomeBanner} alt='' className='h-full w-full'/>
                    
                    <div className='absolute top-10 left-8'>
                        <p className='text-gray-600 mb-4'>Hi, This is Vuyyuri Krishna Varma</p>
                        ...
                        <p className='text-xl mt-2.5 font-bold text-gray-800'> in One Place</p>
